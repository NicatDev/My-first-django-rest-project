...
class TourFilter(django_filters.FilterSet):
    ...
    month = django_filters.DateFilter(field_name='date__month', lookup_expr='exact')         
    date__id = django_filters.CharFilter(lookup_expr='iexact')                
                                        
    class Meta:
        model = Tour
        fields = ['category', "category__id",'type','type__id','date__id' ,'type__name', "category__name","name","description",'month']